...
def modify_avatar():
    try:
        ...
        model_input_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'static', 'models', 'realistic_female.glb'))
        model_output_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'static', 'models', f'modified_{body_shape}_{height}_{weight}.glb'))
        ...
        return jsonify({
            ...
            'height': height,
            'weight': weight,
            'model_path': url_for('static', filename=f'models/modified_{body_shape}_{height}_{weight}.glb')
        })
